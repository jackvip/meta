...
同理，配上阴阳，五行。
### 问题
为什么都是描述种子的生命周期，天干描述的过程，和地支描述的过程有什么区别呢？

天干代表的是 “天元” ，是天上流动的、纯粹的五行之气（如甲为阳木，乙为阴木）。它决定了事物的基本性质和外在表现，它相当于因。
地支代表的是 “地元” ，是地上承载的、复杂的五行之气。地支内部还“藏”着不同强度的天干之气（称为“藏干”）（地支藏干在子平八字里判断强弱和喜用非常重要），这象征着任何事物的发展都不是单一的，而是一个内部有矛盾、有转化的复杂过程，它相当于果。
所以，天干里种子的生命周期，你可以理解为系统预先设定代码。必须是代码先运行，才会出现地支上种子的生命周期的结果。

那么天干为什么是十个地支是十二个呢？
这个数字的选择至关重要，它背后是古人的宇宙观和数学观。
首先天干为十个主要是两个原因：
1. 人类最自然的计数方式源于十根手指，因此“十”在古人心中是一个圆满、循环的基数。
2. 中国上古有“十日并出”和“羿射九日”的神话。传说天上有十个太阳，轮流值日，一个太阳运行一周就是十天，称为“一旬”。这个“十日”周期，很可能就是“十天干”最原始的天文学背景，用于纪日，所以一个月有30日。

其次地支之所以是十二可能有三个原因：
1. 太岁纪年法（木星的轨迹），古人很早就发现，木星（岁星）大约 12年 绕天球一周。
  于是他们将木星的轨道划分为 十二等份，称为“十二次”或“星次”。
2. 月亮周期（阴历月），一个农历年大约有 12个朔望月（月亮圆缺一次），这个“十二”的周期与木星的“十二”次惊人地吻合，进一步强化了“十二”这个数字在历法中的核心地位。
3. 每日的时辰，古人将一天划分为 十二个时段，用十二地支来代表，这就是我们熟悉的“十二时辰”。这为“地支”提供了最贴近日常生活的应用场景。

到这里，天干地支，大家就有一个初步的认识了。
